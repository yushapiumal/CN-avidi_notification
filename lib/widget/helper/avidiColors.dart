...
class AvidiColors {
  ...
  // static const Color cinnamon = Color(0xFF63236E);
  static const Color cinnamon = Color(0xFF8d499e);
  static const Color cinnamonLight = Color.fromARGB(255, 188, 105, 209);
  static const Color lightCinnamonBg = Color.fromARGB(255, 249, 239, 251);
  static const Color cinnamonYellow = Color(0xffffb600);
  static const Color yellowColor = Color(0xFFFED130);
  static const Color menuBackgroundColor = Color(0xff242834);
  static const Color reviewBackgroundColor = Color(0xff2C2D35);
  static const Color greenColor = Color(0xFF60aa00);
  static const Color textColor = Color(0xffCBCBCB);
  static const Color splashBackgroundColor = Color(0xffEEF4FF);
